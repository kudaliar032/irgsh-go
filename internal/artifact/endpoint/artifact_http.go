...
func (A *ArtifactHTTPEndpoint) SubmitPackageHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		httputil.ResponseError("Can't read request body", http.StatusInternalServerError, w)
	}

	httputil.ResponseJSON(jobDetail, http.StatusOK, w)
}

func submissionJobToSubmissionResponse(job service.SubmissionJob) SubmissionResponse {
