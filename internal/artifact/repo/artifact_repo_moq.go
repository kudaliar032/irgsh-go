...
//         mockedRepo := &RepoMock{
//             ExtractSubmittedTarballFunc: func(taskUUID string) error {
...
func (mock *RepoMock) ExtractSubmittedTarball(taskUUID string) error {
	...
	return mock.ExtractSubmittedTarballFunc(taskUUID)
}
